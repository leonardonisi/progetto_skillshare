...
public class MainLayoutGui extends Composite {
    ...
    public MainLayoutGui() {
        ...
        // gestione click sui link di navigazione (cambia vista, andranno poi
        // implementate le vere pagine)
    ...
    // costruisce la vista del marketplace con barra di ricerca, elenco di annunci e
    // dettaglio annuncio
    private Widget creaVistaMarketplace() {
        ...
        ListBox tendinaCategorie = new com.google.gwt.user.client.ui.ListBox();
        ...
        btnPubblica.addClickHandler(new ClickHandler() {
            @Override
            public void onClick(ClickEvent event) {
                new CreateAdGui().mostra();
            }
        });

        searchBar.add(tendinaCategorie);
        searchBar.add(divisorio);
        ...
        lblCategoria.getElement().setId("label-categoria");
